    ...
    try:
        ...
        for stat in stats_list:
            ...
            if media_type not in user_stats[account_id]["media_types"]:
                user_stats[account_id]["media_types"][media_type] = {"duration": 0, "count": 0}
            ...
            if device_id is not None:
                device_info = device_lookup.get(
                    device_id, {"name": f"Unknown Device {device_id}", "platform": "unknown"}
                )
        ...
        for _account_id, stats in user_stats.items():
            ...
            for _media_type, media_stats in stats["media_types"].items():
            ...
            for _device_name, device_stats in stats["devices"].items():
